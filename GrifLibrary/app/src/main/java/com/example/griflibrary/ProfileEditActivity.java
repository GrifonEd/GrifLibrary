...
import com.example.griflibrary.databinding.ActivityProfileEditBinding;
...
public class ProfileEditActivity extends AppCompatActivity {
    ...
    private String lovelyAuthor = "";

    private String lovelyCategory = "";

    private String points = "";

    private String subscription = "";

    private String booksReaded = "";
    ...
    private void validateData() {
        ...
        lovelyAuthor = binding.lovelyAuthorEt.getText().toString().trim();
        lovelyCategory = binding.lovelyCategoryEt.getText().toString().trim();

        if(TextUtils.isEmpty(name)){
            Toast.makeText(this,"Enter name...",Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(lovelyAuthor)) {
            Toast.makeText(this, "Enter author...", Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(lovelyCategory)) {
    ...
    private  void updateProfile(String imageUrl){
        ...
        hashMap.put("lovelyCategory",""+lovelyCategory);
        hashMap.put("lovelyAuthor",""+lovelyAuthor);
        if(imageUrl!=null){
        ...
        databaseReference.child(firebaseAuth.getUid())
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(ProfileEditActivity.this,"Failed to update to update db due to"+e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
    }
        ...
        reference.child(firebaseAuth.getUid())
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        String booksReaded = ""+snapshot.child("booksReaded").getValue();
