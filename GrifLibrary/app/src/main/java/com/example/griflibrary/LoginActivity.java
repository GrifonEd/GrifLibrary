...
import com.example.griflibrary.databinding.ActivityLoginBinding;
...
private  ProgressDialog progressDialog;
    ...
    private void validateData() {
        email = binding.emailEt2.getText().toString().trim();
        password = binding.passwordEt2.getText().toString().trim();
